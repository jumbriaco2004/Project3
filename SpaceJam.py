...
class SpaceJam(ShowBase):
    ...
    def SetupScene(self):
        ...
        self.Player = spaceJamClasses.Player(self.loader, "./Assets/SpaceShips/theBorg.x", self.render, "Player", "./Assets/SpaceShips/theBorg.jpg", (100, 100, 0), 2, self.taskMgr, self.render)
